                ...
                <?php
                    ...
                    if (mysqli_num_rows($result_komen) > 0) {
                        ...
                        while($row_komen = $result_komen->fetch_assoc()) {
                            ...
                            echo '<div style="border: 1px solid orange; width: 100%; height: 83%; display: flex; flex-direction: column; justify-content: flex-start; gap: 2%; background-color: #4b9eec; color: white;">';

                            // Jika bukan pemilik webinar, tampilkan komentar di kiri
                            if (!$isOwner) {
                                // Komentar Pengguna (Kiri)
                                echo '<div style="width: 100%; height: 12.5%; display: flex; flex-direction: row;">';
                            ...
                            if ($isOwner) {
                                ...
                                echo '<div style="width: 100%; height: 12.5%; display: flex; flex-direction: row-reverse;">';
                                echo '    <div style="width: 22.5%; height: 100%; display: flex; justify-content: center; align-items: center;">';
